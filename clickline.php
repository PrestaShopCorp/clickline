...
class ClickLine extends CarrierModule
{
	...
	public static function installExternalCarrier($config)
	{
		...
		foreach ($languages as $language)
		{
			...
			{ //Default
				$delay = isset($config['delay']['en']) ? $config['delay']['en'] : array_shift(array_values($config['delay']));
	...
	private function postProcess()
	{
		if (Tools::isSubmit('submitSave'))
		{
			...
			Configuration::updateValue('CLICKLINE_COUNTRY_FROM', Tools::getvalue('clickline_country_from'));
